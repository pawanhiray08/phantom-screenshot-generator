...
export function TransactionPreview({ data, onBack }: TransactionPreviewProps) {
  ...
  return (
    <div className="space-y-6 w-full max-w-md mx-auto">
      <div className="bg-[#181818] space-y-6">
        ...
        <div className="space-y-4 bg-[#282828] rounded-xl p-4">
          <div className="flex justify-between items-center">
            <span className="text-[#8F8F8F] text-base">Date</span>
            <span className="text-white text-base">{data.date}</span>
          </div>
          <div className="flex justify-between items-center">
            <span className="text-[#8F8F8F] text-base">Status</span>
            <span className="text-[#00D18C] text-base">{data.status}</span>
          </div>
          <div className="flex justify-between items-center">
            <span className="text-[#8F8F8F] text-base">To</span>
            <span className="text-white text-base">{truncateAddress(data.toAddress)}</span>
          </div>
          <div className="flex justify-between items-center">
            <span className="text-[#8F8F8F] text-base">Network</span>
            <span className="text-white text-base">{data.network}</span>
          </div>
          <div className="flex justify-between items-center">
            <span className="text-[#8F8F8F] text-base">Network Fee</span>
            <span className="text-white text-base">−{data.fee} SOL</span>
          </div>
        </div>

        <Button
          className="w-full bg-[#5D5FEF] hover:bg-[#5D5FEF]/90 text-white rounded-full py-6 text-base font-normal"
